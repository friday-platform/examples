...
| ------- | ----------- | ------------ |
| [`pr-review`](pr-review/) | Reviews a GitHub PR, posts inline comments with findings | GitHub |
| [`pr-review-bitbucket`](pr-review-bitbucket/) | Reviews a Bitbucket Cloud PR, posts inline comments with findings | Bitbucket |
